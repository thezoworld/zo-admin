    ...
    <PopoverPrimitive.Root open={open} onOpenChange={handleOpenChange}>
      <PopoverPrimitive.Trigger asChild>
        <button
          ...
          className={cn(
            "inline-flex h-full items-center gap-1.5 rounded-l-3xl pr-2 pl-3 text-sm transition-colors outline-none hover:bg-muted/60 focus-visible:bg-muted/60",
            className
          )}
        >
                ...
                filtered.map((c) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex w-full items-center gap-2.5 rounded-2xl px-3 py-2 text-sm font-medium transition-colors outline-none",
